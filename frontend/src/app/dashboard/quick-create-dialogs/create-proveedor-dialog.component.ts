...
@Component({
    selector: 'app-create-proveedor-dialog',
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
    ...
    template: `
    <h2 mat-dialog-title>Crear Nuevo Proveedor</h2>
    <mat-dialog-content>
      <form [formGroup]="form">
        ...
        <mat-form-field appearance="fill">
          ...
          <input matInput formControlName="persona_contacto">
        </mat-form-field>
...
export class CreateProveedorDialogComponent {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<CreateProveedorDialogComponent>
    ) {
