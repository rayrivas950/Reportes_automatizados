...
from .models import Producto, Cliente, Proveedor, VentaImportada, CompraImportada, Venta, Compra
...
class ReconciliationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.gerente_user = User.objects.create_user(username='gerente_recon', password='password123')
        self.gerente_user.groups.add(self.gerente_group)
        self.client = APIClient()

        # --- Datos Maestros ---
        self.producto_existente = Producto.objects.create(nombre='Varilla de Acero', stock=100)
        self.cliente_existente = Cliente.objects.create(nombre='Constructora Capital', email='contacto@constructoracapital.com')
        self.proveedor_existente = Proveedor.objects.create(nombre='Aceros del Norte', telefono='555-1234')
        ...
        self.venta_importada_valida = VentaImportada.objects.create(
            ...
            cantidad='25',
            precio_venta='350.50',
            datos_fila_original={'producto': 'Varilla de Acero', 'cliente': 'Constructora Capital', 'cantidad': 25, 'precio': 350.50}
        )
        ...
        self.venta_importada_producto_invalido = VentaImportada.objects.create(
            ...
            cantidad='10',
            precio_venta='100.00',
            datos_fila_original={'producto': 'Producto Fantasma', 'cliente': 'Constructora Capital', 'cantidad': 10, 'precio': 100.00}
        )
        ...
        self.venta_importada_cliente_invalido = VentaImportada.objects.create(
            ...
            cantidad='5',
            precio_venta='200.00',
            datos_fila_original={'producto': 'Varilla de Acero', 'cliente': 'Cliente Fantasma', 'cantidad': 5, 'precio': 200.00}
        )
        ...
        self.venta_importada_ya_procesada = VentaImportada.objects.create(
            ...
            cantidad='1',
            precio_venta='1.00',
            datos_fila_original={'producto': 'Varilla de Acero', 'cliente': 'Constructora Capital', 'cantidad': 1, 'precio': 1.00}
        )
        ...
        self.venta_importada_en_conflicto = VentaImportada.objects.create(
            ...
            cantidad='15',
            precio_venta='500.00',
            datos_fila_original={'producto': 'Varilla de Acero', 'cliente': 'Cliente Temporal', 'cantidad': 15, 'precio': 500.00},
        ...
        self.compra_importada_valida = CompraImportada.objects.create(
            ...
            datos_fila_original={'producto': 'Cemento Portland', 'proveedor': 'Aceros del Norte', 'cantidad': 50, 'precio': 8.50}
        )
        # Crear un producto adicional para la compra válida
        self.producto_existente_compra = Producto.objects.create(nombre='Cemento Portland', stock=200)
        ...
        self.compra_importada_producto_invalido = CompraImportada.objects.create(
            ...
            datos_fila_original={'producto': 'Ladrillo Hueco', 'proveedor': 'Aceros del Norte', 'cantidad': 100, 'precio': 1.20}
        )
        ...
        self.compra_importada_proveedor_invalido = CompraImportada.objects.create(
            ...
            datos_fila_original={'producto': 'Varilla de Acero', 'proveedor': 'Proveedor Fantasma', 'cantidad': 50, 'precio': 300.00}
        )
        ...
        self.compra_importada_ya_procesada = CompraImportada.objects.create(
            ...
            datos_fila_original={'producto': 'Varilla de Acero', 'proveedor': 'Aceros del Norte', 'cantidad': 2, 'precio': 2.00}
        )
        ...
        self.compra_importada_en_conflicto = CompraImportada.objects.create(
            ...
            datos_fila_original={'producto': 'Producto Temporal Compra', 'proveedor': 'Proveedor Temporal', 'cantidad': 30, 'precio': 15.00},
            detalles_conflicto={'proveedor': "El proveedor 'Proveedor Temporal' no existe."}
        )
    ...
    def test_procesar_venta_exitosa(self):
        ...
        self.assertEqual(self.venta_importada_valida.estado, VentaImportada.Estados.PROCESADO)
    ...
    def test_procesar_venta_conflicto_producto(self):
        ...
        self.assertEqual(self.venta_importada_producto_invalido.estado, VentaImportada.Estados.CONFLICTO)
        self.assertIn('producto', self.venta_importada_producto_invalido.detalles_conflicto)
        self.assertIn('no existe', self.venta_importada_producto_invalido.detalles_conflicto['producto'])
    ...
    def test_procesar_venta_conflicto_cliente(self):
        ...
        self.assertEqual(self.venta_importada_cliente_invalido.estado, VentaImportada.Estados.CONFLICTO)
        self.assertIn('cliente', self.venta_importada_cliente_invalido.detalles_conflicto)
        self.assertIn('no existe', self.venta_importada_cliente_invalido.detalles_conflicto['cliente'])
    ...
    def test_reprocesar_venta_en_conflicto_exitosa(self):
        ...
        self.assertEqual(self.venta_importada_en_conflicto.estado, VentaImportada.Estados.PROCESADO)
    ...
    def test_procesar_compra_exitosa(self):
        ...
        self.assertEqual(self.compra_importada_valida.estado, CompraImportada.Estados.PROCESADO)
    ...
    def test_procesar_compra_conflicto_producto(self):
        ...
        self.assertEqual(self.compra_importada_producto_invalido.estado, CompraImportada.Estados.CONFLICTO)
        self.assertIn('producto', self.compra_importada_producto_invalido.detalles_conflicto)
        self.assertIn('no existe', self.compra_importada_producto_invalido.detalles_conflicto['producto'])
    ...
    def test_procesar_compra_conflicto_proveedor(self):
        ...
        self.assertEqual(self.compra_importada_proveedor_invalido.estado, CompraImportada.Estados.CONFLICTO)
        self.assertIn('proveedor', self.compra_importada_proveedor_invalido.detalles_conflicto)
        self.assertIn('no existe', self.compra_importada_proveedor_invalido.detalles_conflicto['proveedor'])
    ...
    def test_procesar_compra_no_pendiente_ni_conflicto_falla(self):
        ...
        """
        self.client.force_authenticate(user=self.gerente_user)
        url = f'/api/compras-importadas/{self.compra_importada_ya_procesada.id}/procesar/'
    ...
    def test_reprocesar_compra_en_conflicto_exitosa(self):
        ...
        """
        self.client.force_authenticate(user=self.gerente_user)
        url = f'/api/compras-importadas/{self.compra_importada_en_conflicto.id}/procesar/'
        ...
        self.assertEqual(self.compra_importada_en_conflicto.estado, CompraImportada.Estados.PROCESADO)
